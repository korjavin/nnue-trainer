...
public class PlayerFeatures {
    ...
    public float[] toArray() {
        return new float[] {
            ...
            threatenedLoss, threatTempo, articulation, maxCutLoss, spaceRace,
            sealedBase, neutralUnused, movesLeftTempo, threatenedCuts,
            minCutThreatDist, minEnemyBaseDist, frontOpenness, frontWidth,
            chainReach, severableFrac
        };
    }
}
