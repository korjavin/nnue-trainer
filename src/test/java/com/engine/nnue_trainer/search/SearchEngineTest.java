...
public class SearchEngineTest {
    ...
    public void testAlphaBeta_simpleMinimaxDecision() {
        ...
        float bestScore = engine.alphaBeta(root, 1, Float.NEGATIVE_INFINITY, Float.POSITIVE_INFINITY, 1, true);
    ...
    public void testAlphaBeta_pruning() {
        ...
        engine.setEvaluation(child2_2, 9.0f); // This node should not be evaluated due to alpha-beta pruning
        ...
        float bestScore = engine.alphaBeta(root, 2, Float.NEGATIVE_INFINITY, Float.POSITIVE_INFINITY, 1, true);
